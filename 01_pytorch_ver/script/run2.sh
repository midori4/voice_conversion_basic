...
set model_dir = ../result/trained_model
set conversion_dir = ../result/conversion_result
...
foreach num_hidden (1 2 3 4 5)
    foreach hunits (32 64 128 256)
        ...
        ./train2.sh $train_dir $validation_dir $save_dir $order $num_hidden $hunits $dropout $batchsize $nepoch
